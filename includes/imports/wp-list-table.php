<?php
namespace Affiliate_Bridge\Imports
{
    /**
     * Copy of official WordPress Class file. Copied and distributed as
     * instructed on the WordPress Codex page for WP_List_Table (see below).
     *
     * Only the class name has been changed. No functional code has been 
     * modified.
     * 
    ...
    <?php
        ...
        protected function get_primary_column_name() {
            ...
            if ( ! isset( $columns[ $default ] ) ) {
                $default = AB_WP_List_Table::get_default_primary_column_name();
            }
